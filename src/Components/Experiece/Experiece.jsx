...
export default function Experiece() {
  return (
    <div className='experice mt-[80px]'>
      <HeaderSection title={'Customer experience'}/>
         ...
         <div className="row-grid">
            <div className="col-12 col-xs-12 col-md-6">
                <div className='h-[600px]  m-4 relative'>
                    ...
                    <div className=' mx-4  p-3 bg-gray-600/50 backdrop-blur-md absolute top-[30px] rounded-2xl right-0 left-0 my-0 '>
            ...
            <div className="col-12 col-xs-12 col-md-6">
                <div className='h-[600px] m-4 relative'>
                    ...
                    <div className=' mx-4  p-3 bg-gray-700/50 backdrop-blur-md absolute bottom-[30px] rounded-2xl right-0 left-0 my-0 '>
